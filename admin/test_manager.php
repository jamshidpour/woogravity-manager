...
<div class="wrap">
    ...
    <div class="wgm-help-text">
        <p><?php _e('در این صفحه می‌توانید فرم‌های Gravity Form خود را به عنوان آزمون تنظیم کنید. برای هر فرم می‌توانید Slug (آدرس یکتا)، عنوان، محدودیت زمانی و وضعیت فعال/غیرفعال را تعیین کنید.', 'woogravity-manager'); ?></p>
    </div>
